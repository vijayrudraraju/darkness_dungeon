...
class BossEnemy extends Enemy{
  ...
  BossEnemy():super(
      FlameAnimation.Animation.sequenced("boss_idle.png", 4, textureWidth: 32, textureHeight: 32),
      animationMoveRight: FlameAnimation.Animation.sequenced("boos_run_right.png", 4, textureWidth: 32, textureHeight: 32),
      animationMoveLeft: FlameAnimation.Animation.sequenced("boos_run_left.png", 4, textureWidth: 32, textureHeight: 32),
